...
app.post('/generate-questions', async (req, res) => {
  const { resume, numQuestions } = req.body;
  if (!resume) {
...
- Make sure the questions are effective, clear, and relevant to the candidate's background. Avoid generic or repetitive questions.
- Generate at least ${numQuestions || 10} high-quality questions in total (mix of technical and soft skills).
